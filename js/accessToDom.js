...
const typeItemsContainer=document.getElementById('typeItemsContainer')
const typeItemsContainerItems=document.getElementsByClassName('typeItems-container__item')
const combosIndexCarousel=document.getElementById('combosCarousel')
const drinksIndexCarousel=document.getElementById('drinksCarousel')
const combosContainerIndex=document.getElementById('combosContainerIndex')
const drinksContainerIndex=document.getElementById('drinksContainerIndex')
...
const arrayItemsShoppingCartContainer=document.getElementsByClassName('cartShopping-container__items-item')
...
const addresInput=document.getElementById('adressInput')
